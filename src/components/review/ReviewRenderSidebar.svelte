...
<aside class="review-aside" style={`width: ${asideWidthPx}px;`}>
  ...
  {#if showBackConfirmation}
    <div class="modal-backdrop" on:click={() => showBackConfirmation = false} transition:fade={{ duration: 200 }} />
    <div class="back-modal-wrapper" transition:scale={{ duration: 200, start: 0.95 }}>
      <div class="back-modal-content">
        ...
        <div class="modal-choices">
          <button class="choice-btn primary-choice" on:click={onContinueRecording}>
            <div class="choice-text">
              <strong>Continue Recording</strong>
              <span>Keep your current work and quickly add more footage to it.</span>
            </div>
          ...
          <button class="choice-btn danger-choice" on:click={onResetAndNew}>
            <div class="choice-text">
              ...
              <span>Discard these changes and start a completely fresh recording.</span>
            </div>
            <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <button class="modal-cancel-btn" on:click={() => showBackConfirmation = false}>
          Maybe stay here
        </button>
      </div>
    </div>
