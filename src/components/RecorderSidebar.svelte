...
>
  <div class="mb-4 flex flex-wrap gap-1.5 rounded-xl bg-slate-100/80 p-1.5 dark:bg-slate-800/60">
    <button
      type="button"
      class={`flex-1 min-w-[4rem] rounded-lg px-3 py-2 text-xs font-medium transition-all ${$activeSidebarTab === 'layout' ? 'bg-white text-slate-900 shadow-sm dark:bg-slate-700 dark:text-white' : 'text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white'}`}
    ...
    <button
      type="button"
      class={`flex-1 min-w-[4rem] rounded-lg px-3 py-2 text-xs font-medium transition-all ${$activeSidebarTab === 'webcam' ? 'bg-white text-slate-900 shadow-sm dark:bg-slate-700 dark:text-white' : hasWebcam ? 'text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white' : 'text-slate-400 cursor-not-allowed dark:text-slate-600'}`}
      disabled={!hasWebcam}
    ...
    <button
      type="button"
      class={`flex-1 min-w-[4rem] rounded-lg px-3 py-2 text-xs font-medium transition-all ${$activeSidebarTab === 'mic' ? 'bg-white text-slate-900 shadow-sm dark:bg-slate-700 dark:text-white' : hasMic ? 'text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white' : 'text-slate-400 cursor-not-allowed dark:text-slate-600'}`}
      disabled={!hasMic}
    ...
    <button
      type="button"
      class={`relative flex-1 min-w-[4rem] rounded-lg px-3 py-2 text-xs font-medium transition-all ${$activeSidebarTab === 'notes' ? 'bg-white text-slate-900 shadow-sm dark:bg-slate-700 dark:text-white' : 'text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white'}`}
